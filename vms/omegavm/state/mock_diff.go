...
// Source: github.com/DioneProtocol/odysseygo/vms/platformvm/state (interfaces: Diff)
...
import (
	...
	avax "github.com/DioneProtocol/odysseygo/vms/components/avax"
	fx "github.com/DioneProtocol/odysseygo/vms/platformvm/fx"
	status "github.com/DioneProtocol/odysseygo/vms/platformvm/status"
	txs "github.com/DioneProtocol/odysseygo/vms/platformvm/txs"
...
func (m *MockDiff) AddCurrentAccumulatedFee(arg0 *big.Int) {
	m.ctrl.T.Helper()
...
func (m *MockDiff) GetCurrentAccumulatedFee() (*big.Int, error) {
	m.ctrl.T.Helper()
