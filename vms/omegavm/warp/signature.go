...
type Signature interface {
	...
	// of the validators of [msg.SourceChainID] at [oChainHeight].
	//
...
func (s *BitSetSignature) Verify(
	...
	subnetID, err := oChainState.GetSubnetID(ctx, msg.SourceChainID)
	if err != nil {
		return err
	}

	vdrs, totalWeight, err := GetCanonicalValidatorSet(ctx, oChainState, oChainHeight, subnetID)
	if err != nil {
		return err
	}
