...
// Source: github.com/dioneprotocol/dionego/vms/platformvm/txs (interfaces: UnsignedTx)
...
func (m *MockUnsignedTx) Outputs() []*dione.TransferableOutput {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Outputs")
	ret0, _ := ret[0].([]*dione.TransferableOutput)
	return ret0
}
