...
// Source: github.com/DioneProtocol/odysseygo/vms/platformvm/utxo (interfaces: Verifier)
...
import (
	...
	verify "github.com/DioneProtocol/odysseygo/vms/components/verify"
...
func (m *MockVerifier) VerifySpend(arg0 txs.UnsignedTx, arg1 dione.UTXOGetter, arg2 []*dione.TransferableInput, arg3 []*dione.TransferableOutput, arg4 []verify.Verifiable, arg5 map[ids.ID]uint64) error {
	m.ctrl.T.Helper()
