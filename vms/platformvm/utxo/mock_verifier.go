...
// Source: github.com/dioneprotocol/dionego/vms/platformvm/utxo (interfaces: Verifier)
...
import (
	...
	ids "github.com/dioneprotocol/dionego/ids"
	dione "github.com/dioneprotocol/dionego/vms/components/dione"
	verify "github.com/dioneprotocol/dionego/vms/components/verify"
	state "github.com/dioneprotocol/dionego/vms/platformvm/state"
	txs "github.com/dioneprotocol/dionego/vms/platformvm/txs"
...
func (m *MockVerifier) VerifySpend(arg0 txs.UnsignedTx, arg1 state.UTXOGetter, arg2 []*dione.TransferableInput, arg3 []*dione.TransferableOutput, arg4 []verify.Verifiable, arg5 map[ids.ID]uint64) error {
	m.ctrl.T.Helper()
...
func (m *MockVerifier) VerifySpendUTXOs(arg0 txs.UnsignedTx, arg1 []*dione.UTXO, arg2 []*dione.TransferableInput, arg3 []*dione.TransferableOutput, arg4 []verify.Verifiable, arg5 map[ids.ID]uint64) error {
	m.ctrl.T.Helper()
