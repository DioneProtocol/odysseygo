...
// Source: github.com/DioneProtocol/odysseygo/vms/alpha/states (interfaces: Chain,State,Diff)
...
import (
	...
	choices "github.com/DioneProtocol/odysseygo/snow/choices"
	blocks "github.com/DioneProtocol/odysseygo/vms/alpha/blocks"
	txs "github.com/DioneProtocol/odysseygo/vms/alpha/txs"
...
func (m *MockChain) GetUTXOFromID(arg0 *dione.UTXOID) (*dione.UTXO, error) {
	m.ctrl.T.Helper()
...
// GetUTXOFromID mocks base method.
func (m *MockState) GetUTXOFromID(arg0 *dione.UTXOID) (*dione.UTXO, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUTXOFromID", arg0)
	ret0, _ := ret[0].(*dione.UTXO)
	ret1, _ := ret[1].(error)
...
// GetUTXOFromID mocks base method.
func (m *MockDiff) GetUTXOFromID(arg0 *dione.UTXOID) (*dione.UTXO, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUTXOFromID", arg0)
	ret0, _ := ret[0].(*dione.UTXO)
	ret1, _ := ret[1].(error)
