...
// implementation for an ALPHA client for interacting with alpha [chain]
type client struct {
	requester rpc.EndpointRequester
}

// NewClient returns an ALPHA client for interacting with alpha [chain]
...
func (c *client) GetBlock(ctx context.Context, blkID ids.ID, options ...rpc.Option) ([]byte, error) {
	...
	err := c.requester.SendRequest(ctx, "alpha.getBlock", &api.GetBlockArgs{
		BlockID:  blkID,
...
func (c *client) GetBlockByHeight(ctx context.Context, height uint64, options ...rpc.Option) ([]byte, error) {
	res := &api.FormattedBlock{}
	err := c.requester.SendRequest(ctx, "alpha.getBlockByHeight", &api.GetBlockByHeightArgs{
...
func (c *client) GetHeight(ctx context.Context, options ...rpc.Option) (uint64, error) {
	...
	err := c.requester.SendRequest(ctx, "alpha.getHeight", struct{}{}, res, options...)
...
func (c *client) IssueTx(ctx context.Context, txBytes []byte, options ...rpc.Option) (ids.ID, error) {
	...
	res := &api.JSONTxID{}
	err = c.requester.SendRequest(ctx, "alpha.issueTx", &api.FormattedTx{
		Tx:       txStr,
...
func (c *client) GetTxStatus(ctx context.Context, txID ids.ID, options ...rpc.Option) (choices.Status, error) {
	...
	err := c.requester.SendRequest(ctx, "alpha.getTxStatus", &api.JSONTxID{
		TxID: txID,
	}, res, options...)
...
func (c *client) GetTx(ctx context.Context, txID ids.ID, options ...rpc.Option) ([]byte, error) {
	res := &api.FormattedTx{}
	err := c.requester.SendRequest(ctx, "alpha.getTx", &api.GetTxArgs{
		TxID:     txID,
		Encoding: formatting.Hex,
	}, res, options...)
	if err != nil {
...
func (c *client) GetAtomicUTXOs(
	...
	err := c.requester.SendRequest(ctx, "alpha.getUTXOs", &api.GetUTXOsArgs{
...
func (c *client) GetAssetDescription(ctx context.Context, assetID string, options ...rpc.Option) (*GetAssetDescriptionReply, error) {
	...
	err := c.requester.SendRequest(ctx, "alpha.getAssetDescription", &GetAssetDescriptionArgs{
		AssetID: assetID,
	}, res, options...)
	return res, err
}
...
func (c *client) GetBalance(
	...
	res := &GetBalanceReply{}
	err := c.requester.SendRequest(ctx, "alpha.getBalance", &GetBalanceArgs{
		Address:        addr.String(),
		AssetID:        assetID,
...
func (c *client) GetAllBalances(
	...
	err := c.requester.SendRequest(ctx, "alpha.getAllBalances", &GetAllBalancesArgs{
...
func (c *client) CreateAsset(
	...
	err := c.requester.SendRequest(ctx, "alpha.createAsset", &CreateAssetArgs{
...
func (c *client) CreateNFTAsset(
	...
	err := c.requester.SendRequest(ctx, "alpha.createNFTAsset", &CreateNFTAssetArgs{
		JSONSpendHeader: api.JSONSpendHeader{
			UserPass:       user,
			JSONFromAddrs:  api.JSONFromAddrs{From: ids.ShortIDsToStrings(from)},
			JSONChangeAddr: api.JSONChangeAddr{ChangeAddr: changeAddr.String()},
...
func (c *client) CreateAddress(ctx context.Context, user api.UserPass, options ...rpc.Option) (ids.ShortID, error) {
	res := &api.JSONAddress{}
	err := c.requester.SendRequest(ctx, "alpha.createAddress", &user, res, options...)
	if err != nil {
...
func (c *client) ListAddresses(ctx context.Context, user api.UserPass, options ...rpc.Option) ([]ids.ShortID, error) {
	...
	err := c.requester.SendRequest(ctx, "alpha.listAddresses", &user, res, options...)
	if err != nil {
		return nil, err
	}
...
func (c *client) ExportKey(ctx context.Context, user api.UserPass, addr ids.ShortID, options ...rpc.Option) (*secp256k1.PrivateKey, error) {
	res := &ExportKeyReply{}
	err := c.requester.SendRequest(ctx, "alpha.exportKey", &ExportKeyArgs{
		UserPass: user,
		Address:  addr.String(),
	}, res, options...)
...
func (c *client) ImportKey(ctx context.Context, user api.UserPass, privateKey *secp256k1.PrivateKey, options ...rpc.Option) (ids.ShortID, error) {
	res := &api.JSONAddress{}
	err := c.requester.SendRequest(ctx, "alpha.importKey", &ImportKeyArgs{
		UserPass:   user,
...
func (c *client) Send(
	...
	res := &api.JSONTxID{}
	err := c.requester.SendRequest(ctx, "alpha.send", &SendArgs{
		JSONSpendHeader: api.JSONSpendHeader{
			UserPass:       user,
			JSONFromAddrs:  api.JSONFromAddrs{From: ids.ShortIDsToStrings(from)},
			JSONChangeAddr: api.JSONChangeAddr{ChangeAddr: changeAddr.String()},
...
func (c *client) SendMultiple(
	...
	err := c.requester.SendRequest(ctx, "alpha.sendMultiple", &SendMultipleArgs{
		JSONSpendHeader: api.JSONSpendHeader{
			UserPass:       user,
			JSONFromAddrs:  api.JSONFromAddrs{From: ids.ShortIDsToStrings(from)},
			JSONChangeAddr: api.JSONChangeAddr{ChangeAddr: changeAddr.String()},
...
func (c *client) Mint(
	...
	res := &api.JSONTxID{}
	err := c.requester.SendRequest(ctx, "alpha.mint", &MintArgs{
		JSONSpendHeader: api.JSONSpendHeader{
			UserPass:       user,
			JSONFromAddrs:  api.JSONFromAddrs{From: ids.ShortIDsToStrings(from)},
			JSONChangeAddr: api.JSONChangeAddr{ChangeAddr: changeAddr.String()},
...
func (c *client) SendNFT(
	...
	res := &api.JSONTxID{}
	err := c.requester.SendRequest(ctx, "alpha.sendNFT", &SendNFTArgs{
		JSONSpendHeader: api.JSONSpendHeader{
			UserPass:       user,
			JSONFromAddrs:  api.JSONFromAddrs{From: ids.ShortIDsToStrings(from)},
			JSONChangeAddr: api.JSONChangeAddr{ChangeAddr: changeAddr.String()},
...
func (c *client) MintNFT(
	...
	res := &api.JSONTxID{}
	err = c.requester.SendRequest(ctx, "alpha.mintNFT", &MintNFTArgs{
		JSONSpendHeader: api.JSONSpendHeader{
			UserPass:       user,
			JSONFromAddrs:  api.JSONFromAddrs{From: ids.ShortIDsToStrings(from)},
			JSONChangeAddr: api.JSONChangeAddr{ChangeAddr: changeAddr.String()},
...
func (c *client) Import(ctx context.Context, user api.UserPass, to ids.ShortID, sourceChain string, options ...rpc.Option) (ids.ID, error) {
	res := &api.JSONTxID{}
	err := c.requester.SendRequest(ctx, "alpha.import", &ImportArgs{
		UserPass:    user,
		To:          to.String(),
		SourceChain: sourceChain,
	}, res, options...)
...
func (c *client) Export(
	...
	res := &api.JSONTxID{}
	err := c.requester.SendRequest(ctx, "alpha.export", &ExportArgs{
		JSONSpendHeader: api.JSONSpendHeader{
			UserPass:       user,
			JSONFromAddrs:  api.JSONFromAddrs{From: ids.ShortIDsToStrings(from)},
			JSONChangeAddr: api.JSONChangeAddr{ChangeAddr: changeAddr.String()},
