...
var (
	...
	ApricotPhase4MinOChainHeight = map[uint32]uint64{
		// constants.MainnetID: 793005,
		// constants.TestnetID: 47437,
	}
	ApricotPhase4DefaultMinOChainHeight uint64
...
func GetApricotPhase4MinOChainHeight(networkID uint32) uint64 {
	if minHeight, exists := ApricotPhase4MinOChainHeight[networkID]; exists {
		return minHeight
	}
	return ApricotPhase4DefaultMinOChainHeight
}
