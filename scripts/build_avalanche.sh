...
go build $build_args -ldflags "-X github.com/DioneProtocol/odysseygo/version.GitCommit=$git_commit $static_ld_flags" -o "$avalanchego_path" "$AVALANCHE_PATH/main/"*.go
