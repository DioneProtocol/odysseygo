	...
	errs.Add(
		vmRegisterer.Register(context.TODO(), constants.OmegaVMID, &omegavm.Factory{
			Config: omegaconfig.Config{
				...
				ApricotPhase7TxFee:                     n.Config.ApricotPhase7TxFee,
				...
				ApricotPhase7MinValidatorStakeDuration: n.Config.ApricotPhase7MinValidatorStakeDuration,
				ApricotPhase7MinDelegatorStakeDuration: n.Config.ApricotPhase7MinDelegatorStakeDuration,
