...
// GetBigInt mocks base method.
func (m *MockSharedMemory) GetBigInt(arg0 ids.ID, arg1 []byte) (*big.Int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetBigInt", arg0, arg1)
	ret0, _ := ret[0].(*big.Int)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetBigInt indicates an expected call of GetBigInt.
func (mr *MockSharedMemoryMockRecorder) GetBigInt(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetBigInt", reflect.TypeOf((*MockSharedMemory)(nil).GetBigInt), arg0, arg1)
}
