...
// Package state manages the meta-data required by consensus for an dione
// dag.
package state
...
func (s *Serializer) ParseVtx(ctx context.Context, b []byte) (dione.Vertex, error) {
...
func (s *Serializer) GetVtx(_ context.Context, vtxID ids.ID) (dione.Vertex, error) {
