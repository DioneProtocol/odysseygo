...
func TestEngineAdd(t *testing.T) {
	...
	vtx := &dione.TestVertex{
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Processing,
		},
		ParentsV: []dione.Vertex{
			&dione.TestVertex{TestDecidable: choices.TestDecidable{
				IDV:     ids.GenerateTestID(),
	...
	manager.ParseVtxF = func(_ context.Context, b []byte) (dione.Vertex, error) {
	...
	manager.ParseVtxF = func(context.Context, []byte) (dione.Vertex, error) {
...
func TestEngineQuery(t *testing.T) {
	...
	gVtx := &dione.TestVertex{TestDecidable: choices.TestDecidable{
		IDV:     ids.GenerateTestID(),
		StatusV: choices.Accepted,
	}}
	mVtx := &dione.TestVertex{TestDecidable: choices.TestDecidable{
		IDV:     ids.GenerateTestID(),
		StatusV: choices.Accepted,
	}}

	vts := []dione.Vertex{gVtx, mVtx}
	...
	manager.GetVtxF = func(_ context.Context, id ids.ID) (dione.Vertex, error) {
		switch id {
		case gVtx.ID():
			return gVtx, nil
		case mVtx.ID():
	...
	vertexed := new(bool)
	manager.GetVtxF = func(_ context.Context, vtxID ids.ID) (dione.Vertex, error) {
		if *vertexed {
...
func TestEngineMultipleQuery(t *testing.T) {
	...
	engCfg.Params = dione.Parameters{
...
func TestEngineAbandonResponse(t *testing.T) {
	...
	manager.GetVtxF = func(context.Context, ids.ID) (dione.Vertex, error) {
		return nil, errUnknownVertex
	}
...
func TestEngineRejectDoubleSpendTx(t *testing.T) {
	...
	manager.BuildVtxF = func(_ context.Context, _ []ids.ID, txs []snowstorm.Tx) (dione.Vertex, error) {
		return &dione.TestVertex{
			TestDecidable: choices.TestDecidable{
				IDV:     ids.GenerateTestID(),
				StatusV: choices.Processing,
			},
			ParentsV: []dione.Vertex{gVtx, mVtx},
			HeightV:  1,
			TxsV:     txs,
			BytesV:   []byte{1},
		}, nil
...
func TestEngineReissue(t *testing.T) {
	...
	vm.CantSetState = true
	lastVtx := new(dione.TestVertex)
	manager.BuildVtxF = func(_ context.Context, _ []ids.ID, txs []snowstorm.Tx) (dione.Vertex, error) {
		lastVtx = &dione.TestVertex{
			TestDecidable: choices.TestDecidable{
				IDV:     ids.GenerateTestID(),
				StatusV: choices.Processing,
			},
...
func TestEngineGetVertex(t *testing.T) {
	...
	manager.Default(true)
	engCfg.Manager = manager
	dioneGetHandler, err := dionegetter.New(manager, commonCfg)
	if err != nil {
		t.Fatal(err)
	}
	engCfg.AllGetsServer = dioneGetHandler
...
func TestEngineParentBlockingInsert(t *testing.T) {
	...
	parentVtx := &dione.TestVertex{
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Processing,
		},
		ParentsV: []dione.Vertex{missingVtx},
		HeightV:  2,
		BytesV:   []byte{0, 1, 2, 3},
	}

	blockingVtx := &dione.TestVertex{
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Processing,
		},
		ParentsV: []dione.Vertex{parentVtx},
		HeightV:  3,
		BytesV:   []byte{0, 1, 2, 3},
	}
...
func TestEngineDuplicatedIssuance(t *testing.T) {
	...
	manager.BuildVtxF = func(context.Context, []ids.ID, []snowstorm.Tx) (dione.Vertex, error) {
...
func TestEngineBubbleVotes(t *testing.T) {
	...
	missingVtx := &dione.TestVertex{TestDecidable: choices.TestDecidable{
		IDV:     ids.GenerateTestID(),
		StatusV: choices.Unknown,
	}}

	pendingVtx0 := &dione.TestVertex{
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Processing,
		},
		ParentsV: []dione.Vertex{vtx, missingVtx},
		HeightV:  1,
		TxsV:     []snowstorm.Tx{tx1},
		BytesV:   []byte{1},
	}

	pendingVtx1 := &dione.TestVertex{
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Processing,
		},
		ParentsV: []dione.Vertex{pendingVtx0},
		HeightV:  2,
		TxsV:     []snowstorm.Tx{tx2},
		BytesV:   []byte{2},
	}
...
func TestAbandonTx(t *testing.T) {
	...
	vtx0 := &dione.TestVertex{ // Contains tx0, which will fail verification
		TestDecidable: choices.TestDecidable{
			IDV:     ids.GenerateTestID(),
			StatusV: choices.Unknown,
		},
		ParentsV: []dione.Vertex{gVtx},
