...
type priorityQueue []dione.Vertex
...
func (vh *maxHeightVertexHeap) Push(vtx dione.Vertex) bool {
	vtxID := vtx.ID()
...
func (vh *maxHeightVertexHeap) Pop() dione.Vertex {
	vtx := heap.Pop(&vh.heap).(dione.Vertex)
