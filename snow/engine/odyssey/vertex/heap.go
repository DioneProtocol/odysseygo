...
type priorityQueue []odyssey.Vertex
...
func (vh *maxHeightVertexHeap) Push(vtx odyssey.Vertex) bool {
	vtxID := vtx.ID()
...
func (vh *maxHeightVertexHeap) Pop() odyssey.Vertex {
	vtx := heap.Pop(&vh.heap).(odyssey.Vertex)
